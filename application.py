...
def result():
    ...
    authenticate = tweepy.OAuthHandler(
        '7jy0TazImsgjy9wjRGb2fSaRu', 'tduhf6sADKU9ajSiawBewtNxnR2NJHkqVSq1TM8hOt7fvX7yGL')

    authenticate.set_access_token(
        '1591889475860561920-6RabaKy2Y7BzKe1cXlDAsDZeGWkMbf', 'x8gSwP6x38EbJsw3XD6ptffeTULCaNtggPeJIn6TFfYgk')
